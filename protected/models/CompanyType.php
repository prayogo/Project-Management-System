...
/**
 * This is the model class for table "ltcompanytype".
 *
 * The followings are the available columns in table 'ltcompanytype':
...
class CompanyType extends CActiveRecord
{
	...
	public function rules()
	{
		...
		return array(
			...
			array('CompanyType', 'length', 'max'=>150),						
			// The following rule is used by search().
			// @todo Please remove those attributes that should not be searched.
			array('CompanyTypeId, CompanyType', 'safe', 'on'=>'search'),
	...
	public function relations()
	{
		...
		return array(
			'mscustomers' => array(self::HAS_MANY, 'Mscustomer', 'CompanyTypeId'),
		);
	}
