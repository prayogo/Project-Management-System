 ...
 */
class UserGroupForm extends CActiveRecord
{
	 ...
	 * @return UserGroupForm the static model class
	 */
	...
	/**
	 * Function for get list user group menu
	...
	*/
	public function getUserGroupList($UserId){
		...
		try
		{ 
			$sql = "call Spr_Get_UserGroupList (".$UserId.")";
