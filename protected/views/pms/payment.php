...
?>
<h1 class="blok"><i class="fi-torso-business"></i> Project</h1>
<div class="blok">
  <div class="row collapse" style="margin-top:5px">
    <div class="columns" style="width:auto; float:left; margin-right: 10px">     
      <a class="button tiny" style="margin-bottom:0px" href="<?php echo Yii::app()->createUrl('project/manageproject') ?>"><i class="fi-plus"></i> Add New Project</a>	    	
    </div>
  </div>  
  <hr />
  <div class="metro">
